  ...
  return (
    <div className="App">
      <form onSubmit={onSubmitHandler}>
        ...
        <div className="form-group">
          <label htmlFor="occupation" className="form-label">Class You Want To Apply For*</label>
          <select className="form-select" name="occupation" onChange={onChangeHandler} value={formData.occupation}>
            <option value="">Select Class</option>
            <option value="student">1st</option>
            <option value="employee">2nd</option>
            <option value="other">3rd</option>
            <option value="student">4th</option>
        ...
        <div className="form-group">
          <label htmlFor="gender" className="form-label">Languages Known</label>
          <div>
            <div>
            ...
            <div>
              ...
              <label htmlFor="javascript">Telugu</label>
            </div>
          </div>
